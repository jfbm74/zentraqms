...
class UserAdmin(BaseUserAdmin):
    ...
    def account_status(self, obj):
        ...
        if obj.is_account_locked():
            ...
            return format_html(
                '<span style="color: blue; font-weight: bold;">📧 No verificado</span>'
            )
        else:
            return format_html(
    ...
    def verify_users(self, request, queryset):
        ...
        self.message_user(
            request,
            _('%(count)d usuarios han sido verificados.') % {'count': updated}
        )
    ...
    def unverify_users(self, request, queryset):
        ...
        self.message_user(
            request,
            _('%(count)d usuarios han sido marcados como no verificados.') % {'count': updated}
        )
    ...
    def unlock_users(self, request, queryset):
        ...
        self.message_user(
            request,
            _('%(count)d cuentas han sido desbloqueadas.') % {'count': count}
        )
    ...
    def activate_users(self, request, queryset):
        ...
        self.message_user(
            request,
            _('%(count)d usuarios han sido activados.') % {'count': updated}
        )
    ...
    def deactivate_users(self, request, queryset):
        ...
        self.message_user(
            request,
            _('%(count)d usuarios han sido desactivados.') % {'count': updated}
        )
