...
class LoginViewTests(JWTAuthenticationTestCase):
    ...
    def test_login_invalid_email(self):
        ...
        data = {"email": "nonexistent@zentraqms.com", "password": "TestPass123!"}
    ...
    def test_login_invalid_password(self):
        ...
        data = {"email": self.user_data["email"], "password": "WrongPassword123!"}
    ...
    def test_login_inactive_user(self):
        ...
        data = {"email": self.inactive_user.email, "password": "TestPass123!"}
    ...
    def test_login_locked_account(self):
        ...
        data = {"email": self.locked_user.email, "password": "TestPass123!"}
...
class SecurityTests(JWTAuthenticationTestCase):
    ...
    def test_failed_login_does_not_reveal_user_existence(self):
        ...
        data1 = {"email": "nonexistent@zentraqms.com", "password": "SomePassword123!"}
        response1 = self.client.post(self.login_url, data1)

        # Try with existing user but wrong password
        data2 = {"email": self.user_data["email"], "password": "WrongPassword123!"}
