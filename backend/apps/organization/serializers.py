...
class LocationCreateSerializer(LocationSerializer):
    ...
    class Meta(LocationSerializer.Meta):
        fields = [field for field in LocationSerializer.Meta.fields if field != 'organization']
...
class OrganizationWizardStep1Serializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        required_fields = ['razon_social', 'nit', 'digito_verificacion', 'tipo_organizacion', 'sector_economico']
