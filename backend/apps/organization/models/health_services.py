...
Models:
    - HealthServiceCatalog: Master catalog of health services
    - SedeHealthService: Services enabled at specific headquarters
    - ServiceImportLog: Audit trail for REPS Excel imports
"""
