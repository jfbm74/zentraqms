...
class OrganizationViewSet(viewsets.ModelViewSet):
    ...
    def exists_check(self, request):
        ...
        try:
            ...
            return Response({
                'exists': exists,
                'count': count,
                'message': 'Organizations found' if exists else 'No organizations configured'
    ...
    def wizard_step1(self, request):
        ...
        if request.method == 'GET':
            ...
            organization = Organization.objects.first()  # Temporal: obtener primera organización
            ...
            if organization:
                ...
                return Response({
                    ...
                    'step_completed': True,
                    'message': _('Organización ya configurada. Puede editarla si es necesario.')
                })
            else:
            ...
            if serializer.is_valid():
                ...
                return Response({
                    ...
                    'step_completed': True,
                    'message': message
                }, status=status.HTTP_200_OK if organization else status.HTTP_201_CREATED)
            else:
                return Response({
    ...
    def calculate_verification_digit(self, request):
        ...
        try:
            ...
            return Response({
                'error': _('Error calculando dígito de verificación: {}').format(str(e))
            }, status=status.HTTP_400_BAD_REQUEST)
    ...
    def rollback(self, request, pk=None):
        ...
        try:
            ...
            can_rollback, rollback_reason = AuditLog.can_rollback(organization, audit_log_id)
            if not can_rollback:
                return Response({
    ...
    def wizard_step1(self, request):
        ...
        if request.method == 'GET':
            ...
            if main_location:
                ...
                serializer = self.get_serializer(main_location, data=request.data, partial=True)
            else:
            ...
            if serializer.is_valid():
                ...
                return Response({
                    ...
                    'step_completed': True,
                    'message': message
                }, status=status.HTTP_200_OK if main_location else status.HTTP_201_CREATED)
            else:
                return Response({
                    'errors': serializer.errors,
                    'message': _('Por favor corrija los errores en el formulario.')
...
class SectorTemplateViewSet(viewsets.ModelViewSet):
    ...
    ordering_fields = ['nombre_template', 'sector', 'aplicaciones_exitosas', 'created_at']
