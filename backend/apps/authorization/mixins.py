...
class PermissionRequiredMixin:
    ...
    def check_permissions(self, request):
        ...
        if self.permission_required_all:
            ...
            if not PermissionChecker.user_has_all_permissions(request.user, permissions):
                raise PermissionDenied(
...
class ResourcePermissionMixin:
    ...
    def filter_queryset_by_permissions(self, queryset):
        ...
        if PermissionChecker.user_has_permission(user, f'{self.resource_permission}.list'):
            return queryset
