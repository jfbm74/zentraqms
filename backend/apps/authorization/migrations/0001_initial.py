    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["code"], name="authorizati_code_a759f5_idx"),
                    models.Index(
                        fields=["resource", "action"],
                        name="authorizati_resourc_8bd77c_idx",
                    ),
                    models.Index(
                        fields=["is_active"], name="authorizati_is_acti_195b47_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["role", "permission"], name="authorizati_role_id_fea942_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="role",
            index=models.Index(
                fields=["is_active"], name="authorizati_is_acti_377d9c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="role",
            index=models.Index(
                fields=["is_system"], name="authorizati_is_syst_327daf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userrole",
            index=models.Index(
                fields=["user", "is_active"], name="authorizati_user_id_dd400e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userrole",
            index=models.Index(
                fields=["role", "is_active"], name="authorizati_role_id_48adcf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userrole",
            index=models.Index(
                fields=["expires_at"], name="authorizati_expires_bd4f17_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="userrole",
