                                    ...
                                    <div className="p-2 border rounded">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <p className="text-uppercase fw-medium text-muted mb-1">SUH</p>
                                                <h5 className="mb-0">92.5%</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className="p-2 border rounded">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <p className="text-uppercase fw-medium text-muted mb-1">PAMEC</p>
                                                <h5 className="mb-0">78.3%</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className="p-2 border rounded">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <p className="text-uppercase fw-medium text-muted mb-1">SIC</p>
                                                <h5 className="mb-0">95.1%</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-6">
                                    <div className="p-2 border rounded">
                                        <div className="d-flex align-items-center">
                                            ...
                                            <div className="flex-grow-1 ms-3">
                                                <p className="text-uppercase fw-medium text-muted mb-1">SUA</p>
                                                <h5 className="mb-0">45.7%</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
