      ...
      <div className="row">
        <div className="col-12">
          <div className="alert alert-primary alert-border-left" role="alert">
            ...
            Bienvenido/a <strong>{user?.first_name || "Usuario"}</strong> al
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h5 className="fs-13 mb-0">
                              Nuevo proceso creado: "Control de Calidad v2.1"
                            </h5>
                          </div>
                        </div>
                      </td>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h5 className="fs-13 mb-0">
                              Auditoría interna programada para el área de
                              Producción
                            </h5>
                          </div>
                        </div>
                    ...
                    <tr>
                      <td>
                        <div className="d-flex align-items-center">
                          ...
                          <div>
                            <h5 className="fs-13 mb-0">
                              Documento actualizado en Normograma: ISO 9001:2015
                            </h5>
                          </div>
                        </div>
                      </td>
            ...
            <div className="card-body">
              <div className="text-center">
                ...
                <p className="text-muted">
                  El sistema mantiene un 95.8% de conformidad con los estándares
