              ...
              <div className="col-md-8 col-lg-6 col-xl-5">
                <div className="card mt-4 card-bg-fill">
                  <div className="card-body p-4 text-center">
                    ...
                    <div className="mt-5">
                      <h1 className="ff-secondary fw-semibold text-primary lh-base">
                        404
                      </h1>
                      <h4 className="text-uppercase">Página No Encontrada</h4>
                      <p className="text-muted mb-4">
                        Lo sentimos, la página que está buscando no existe o ha
                        sido movida.
                      </p>
            ...
            <div className="col-lg-12">
              <div className="text-center">
                <p className="mb-0 text-muted">
                  &copy; {new Date().getFullYear()} ZentraQMS. Desarrollado con{" "}
                  <i className="mdi mdi-heart text-danger"></i> para la
