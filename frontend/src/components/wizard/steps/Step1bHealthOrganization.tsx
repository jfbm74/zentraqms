/**
 * Step 1b: Health Organization Data Component (Conditional)
 *
...
const Step1bHealthOrganization: React.FC<Step1bProps> = ({
  data,
  errors,
  onChange,
  organizationName = "",
    ...
    <div className="health-organization-step">
            ...
            <div className="d-flex align-items-start">
              ...
              <div className="flex-grow-1 ms-3">
                <h5 className="alert-heading mb-2">
                  Organización del Sector Salud Detectada
                </h5>
                <p className="mb-2">
                  <strong>{organizationName}</strong> será configurada como una institución prestadora de servicios de salud.
                  Complete la información específica requerida por la normatividad colombiana.
                </p>
                <hr className="my-3" />
      ...
      <div className="mb-4">
        <div className="d-flex justify-content-between align-items-center mb-2">
          <h5 className="mb-0">Paso 1b: Información de Salud</h5>
        ...
        <small className="text-muted mt-1 d-block">
          Complete la información específica para instituciones de salud
        </small>
      </div>
          ...
          <div className="card border-0 shadow-sm">
            <div className="card-header bg-success bg-opacity-10 py-2">
              <div className="d-flex align-items-center">
                ...
                <h6 className="mb-0">Resumen de Validación</h6>
              </div>
            </div>
            <div className="card-body p-3">
...
export default Step1bHealthOrganization;