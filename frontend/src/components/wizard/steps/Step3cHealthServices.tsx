/**
 * Step 3c: Health Services Selection (Conditional)
 *
...
const Step3cHealthServices: React.FC<Step3cProps> = ({
  selectedServices,
  nivelComplejidad,
  organizationName = "",
  selectedSector = "",
    ...
    <div className="health-services-step">
          ...
          <div className="alert alert-success border-0 shadow-sm">
            <div className="d-flex align-items-start">
              <div className="flex-shrink-0">
                <i className="ri-health-book-line text-success" style={{ fontSize: '2rem' }}></i>
              </div>
              <div className="flex-grow-1 ms-3">
                ...
                <p className="mb-2">
                  Excelente! Ya tenemos la información básica de <strong>{organizationName}</strong> como 
                  institución de salud de nivel <strong>{nivelComplejidad}</strong>.
                </p>
                <p className="mb-0">
                  Ahora seleccione los servicios específicos que prestará. Esta configuración será 
                  fundamental para estructurar los procesos QMS y módulos de calidad apropiados.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="mb-4">
        <div className="d-flex justify-content-between align-items-center mb-2">
          <h5 className="mb-0">Paso 3c: Servicios de Salud</h5>
          ...
          <div className="row align-items-center">
            <div className="col-md-8">
              <h6 className="card-title mb-1">
                ...
                Configuración Rápida por Nivel
              </h6>
              <p className="card-text mb-0">
                <small className="text-muted">
                  ¿Desea que ZentraQMS seleccione automáticamente los servicios más comunes 
            ...
            <div className="col-md-4 text-end">
              <button 
                ...
                onClick={() => {
                  // Auto-select common services based on complexity level
                  // This would be implemented with pre-defined service sets
                }}
              >
                ...
                <div className="position-relative d-inline-block">
                  ...
                  >
                    ...
                    <div className="position-absolute top-50 start-50 translate-middle">
                      <small className="fw-bold text-success">{completionPercentage}%</small>
                    </div>
                  </div>
                </div>
        ...
        <div className="card border-0 bg-light">
          <div className="card-body p-3">
            <h6 className="card-title mb-2">
              <i className="ri-roadmap-line me-2 text-primary"></i>
              Próximos Pasos en el QMS
            </h6>
            <p className="card-text mb-2">
              <small className="text-muted">
                Una vez complete la configuración inicial, ZentraQMS activará automáticamente:
              </small>
            </p>
            <div className="row">
              <div className="col-md-4">
                <div className="d-flex align-items-center mb-2">
                  ...
                  <small>Módulo SUH (Sistema Único de Habilitación)</small>
                </div>
              </div>
              <div className="col-md-4">
                <div className="d-flex align-items-center mb-2">
                  <i className="ri-heart-pulse-line text-danger me-2"></i>
                  <small>Módulo PAMEC (Programa de Auditoría)</small>
                </div>
              </div>
              <div className="col-md-4">
                <div className="d-flex align-items-center mb-2">
                  <i className="ri-award-line text-warning me-2"></i>
                  <small>Módulo SOGCS (Sistema de Gestión de Calidad)</small>
                </div>
              </div>
            </div>
          </div>
...
export default Step3cHealthServices;