      ...
      <div className="navbar-header">
        ...
        <div className="d-flex align-items-center">
          ...
          <div className="navbar-brand-box d-lg-none d-md-block">
            <a
              href="/"
              className="logo logo-dark d-flex align-items-center text-decoration-none"
            >
              <img
                src={logoSm}
                alt="Logo"
              ...
              />
              <span className="ms-2 fw-semibold text-primary d-none d-sm-inline-block company-name">
                ZentraQMS
              </span>
            </a>
          </div>
                      ...
                      <div className="d-flex">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="fs-12 text-muted">
                            <p className="mb-1">
                              Se completó la auditoría del proceso de compras
                            </p>
                            <p className="mb-0">
                              <i className="ri-time-line align-middle"></i> Hace
                              30 min
                            </p>
                          </div>
                        </div>
                    ...
                    >
                      <div className="d-flex">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="fs-12 text-muted">
                            <p className="mb-1">
                              El indicador de satisfacción bajó a 75%
                            </p>
                            <p className="mb-0">
                              <i className="ri-time-line align-middle"></i> Hace
                              2 horas
